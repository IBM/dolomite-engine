...
# export NCCL_IB_QPS_PER_CONNECTION=8  #Feb 3 based on @rpands yaml
...
export OMP_NUM_THREADS=16 # March 29 increase to 96 or 1/2 vCPUs watch for OOM 
...
export NCCL_NVLS_ENABLE=1  #1(on) is the default anyway 
