...
from engine.utils.distributed import get_local_rank, get_world_size
from engine.utils.logging import print_rank_0
from engine.utils.monitoring import register_timer
...
def deepspeed_initialize(
    ...
    from engine.data.sampler import ConcatenatedDataSampler
