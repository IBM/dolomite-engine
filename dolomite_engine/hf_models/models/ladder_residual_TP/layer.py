...
class LadderResidualBlock_TP(GPTDolomiteBlock_TP):
    def forward(
        ...
        current_attention_out = rmsnorm_cute(x=residual, weight=self.ln_1.weight, eps=self.ln_1.eps)
        ...
        current_mlp_out = rmsnorm_cute(x=residual, weight=self.ln_2.weight, eps=self.ln_2.eps)
