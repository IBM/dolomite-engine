...
class LadderResidualBlock_TP(GPTDolomiteBlock_TP):
    ...
    def forward(
        ...
        residual, ln_2_weight = rmsnorm_cute_backward(residual, ln_2_weight, self.ln_2.eps, self.sequence_parallel, "mlp")
        ...
        current_mlp_out = rmsnorm_cute_forward(residual, ln_2_weight, self.ln_2.eps, self.sequence_parallel, "mlp")
