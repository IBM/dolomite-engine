...
from .layer import GPTLadderBlock


class GPTLadderPreTrainedModel(PreTrainedModelMixin):
    config_class = GPTLadderConfig
    layer_class = GPTLadderBlock
    _no_split_modules = ["GPTLadderBlock"]


class GPTLadderModel(GPTLadderPreTrainedModel, BaseModelMixin):
    def __init__(self, config: GPTLadderConfig, **kwargs) -> None:
